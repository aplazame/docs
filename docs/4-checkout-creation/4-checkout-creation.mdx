...
Si estás iniciando la integración, te puede interesar consultar cómo establecer el [modo de pruebas](../test-environment/test-mode) y también los [datos de prueba](../test-environment/test-data) disponibles para la integración.

Para mejorar la concesión de crédito, es recomendable que configures el envío del historial de pedidos del cliente ([ver documentación](../api-orders/history)).
