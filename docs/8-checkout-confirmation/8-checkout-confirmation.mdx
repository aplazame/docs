...
total_amount | [decimal](./integraciones/api/api-reference/#decimales) | Cantidad a financiar.
tax_rate | [decimal](./integraciones/api/api-reference/#decimales) | Importe de descuento en el precio del pedido.
discount | [decimal](./integraciones/api/api-reference/#decimales) | Importe de descuento en el precio del pedido.
discount_rate | [decimal](./integraciones/api/api-reference/#decimales) | Tasa de descuento en el precio del pedido.
