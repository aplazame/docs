---
title: Confirmación del checkout
sidebar_position: 4
...
total_amount | $type{decimal} | Cantidad a financiar.
tax_rate | $type{decimal} | Importe de descuento en el precio del pedido.
discount | $type{decimal} | Importe de descuento en el precio del pedido.
discount_rate | $type{decimal} | Tasa de descuento en el precio del pedido.
currency | $type{currency} | Divisa del pedido.
rejected | boolean |El pedido ha sido rechazado.
confirmed | $type{date} | Fecha y hora de confirmacion del pedido.
verified | $type{date} | Fecha y hora de verificación del pedido.
expired | $type{date} | Fecha y hora en que el pedido expiró.
expires_at | $type{date} | Fecha y hora de expiración del pedido.
cancelled | $type{date} | Fecha y hora de cancelación del pedido.
created | $type{date} | Fecha y hora de creación del pedido.
