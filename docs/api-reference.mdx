...
client = aplazame_sdk.Client('$api_token{private}', ctype='json', version='1')
...
client = aplazame_sdk.Client('$api_token{private}', version='1')

client = aplazame_sdk.Client('$api_token{private}', ctype='xml')
```
  </TabItem>
</Tabs>
