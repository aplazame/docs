...
|---------|---------|---------|---------|
id | string | ${yes} | `ID` del artículo
name | string | ${yes} | Nombre del artículo
description | string | ${no} | Descripción del artículo
url | URL | ${yes} | URL absoluta del artículo
...
:::info
Ver [documentación de paginación](../../api-reference/#paginacion)
:::
