...
La petición **POST** debe enviar los siguientes campos:
<Tabs>
...
const aplazame = require('@aplazame/node')({
  access_token: '$api_token{private}',
  is_sandbox: true,
})
...
$ curl --request POST "https://api.aplazame.com/checkout" \
    ...
    --header "Authorization: Bearer $api_token{private}" \
