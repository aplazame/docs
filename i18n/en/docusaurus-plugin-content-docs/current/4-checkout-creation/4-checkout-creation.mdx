...
To improve the provision of credit, it is recommended that you configure the sending of the customer's order history ([see documentation](../orders/#history)).
...
discount | [decimal](./integraciones/api/api-reference/#decimales) | No | Discount amount of the order
discount_rate | [decimal](./integraciones/api/api-reference/#decimales) | No | Discount rate on the price of the order
cart_discount | [decimal](./integraciones/api/api-reference/#decimales) | No | Discount amount of the cart
cart_discount_rate | [decimal](./integraciones/api/api-reference/#decimales) | No | Discount rate of the cart
currency | [ISO 4217](https://es.wikipedia.org/wiki/ISO_4217) | <t id="table.yes">Sí</t> | Currency code of the order
total_amount | [decimal](./integraciones/api/api-reference/#decimales) | <t id="table.yes">Sí</t> | Order tax rate
[tax_rate](#tax_rate) | [decimal](./integraciones/api/api-reference/#decimales) | <t id="table.yes">Sí</t> | Total order amount
...
price | [decimal](./integraciones/api/api-reference/#decimales) | <t id="table.yes">Sí</t> | Price (tax not included)
tax_rate | [decimal](./integraciones/api/api-reference/#decimales) | No | Tax rate
discount | [decimal](./integraciones/api/api-reference/#decimales) | No | Discount amount
discount_rate | [decimal](./integraciones/api/api-reference/#decimales) | No | Discount rate
...
price | [decimal](./integraciones/api/api-reference/#decimales) | <t id="table.yes">Sí</t> | Shipping price (tax is not included)
tax_rate | [decimal](./integraciones/api/api-reference/#decimales) | No | Shipping tax rate
discount | [decimal](./integraciones/api/api-reference/#decimales) | No | Discount amount of the shipping
discount_rate | [decimal](./integraciones/api/api-reference/#decimales) | No | Discount rate of the shipping
