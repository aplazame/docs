...
start_date | [ISO 8601](https://es.wikipedia.org/wiki/ISO_8601) | Start date of the campaign
end_date | [ISO 8601](https://es.wikipedia.org/wiki/ISO_8601) | End date of the campaign
interest | [decimal](../../api-reference#decimals) | Interest discount rate
