...
start_date | $type{date} | ${yes} | Start date of the campaign
end_date | $type{date} | ${no} | End date of the campaign
interest | $type{decimal} | ${yes} | Interest discount rate
...
min_order_amount | $type{decimal} | ${no} | [Minimum shopping cart amount (order.total_amount)](../checkout-creation/#order) to which the campaign applies
max_order_amount | $type{decimal} | ${no} | [Maximum shopping cart amount (order.total_amount)](../checkout-creation/#order) to which the campaign applies
