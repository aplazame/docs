...
---
# Plugin for Magento
Here you will find everything related to the Aplazame plugin for **Magento version 2** and later. If you have an older version, in the section [Magento previous versions](./old-magento) you have our old plugin available.
