...
|data-article-id | texto | No | The article identifier. It cannot have spaces. In case of having a partial campaign that includes it, the widget may indicate said campaign. You can [include multuple articles](#include-multuple-articles) if required.
