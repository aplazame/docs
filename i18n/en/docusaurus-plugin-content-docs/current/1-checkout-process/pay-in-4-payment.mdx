...
title: Pay in 4
sidebar_position: 4
keywords: [checkout aplazame, Pay in 4]
---
...
## Checkout process
![checkout-flow](/img/en/checkout-integration-flow-en.svg "checkout-flow lightTheme")
![checkout-flow](/img/en/checkout-integration-flow-en-dark.svg "checkout-flow darkTheme")
...
* [JavaScript SDK](../../sdk-javascript/#check-available-products)
