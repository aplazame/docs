...
## Checkout process
![checkout-flow](/img/en/checkout-paylater-integration-flow-en.svg "checkout-flow lightTheme")
![checkout-flow](/img/en/checkout-paylater-integration-flow-en-dark.svg  "checkout-flow darkTheme")
