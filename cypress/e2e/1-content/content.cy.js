...
const {
  LANG = 'es',
  URL_ES = 'http://localhost:3000/',
  URL_EN = 'http://localhost:3000/en/',
} = process.env
  ...
  ;['ES', 'EN'].forEach(lang => {
    ...
    context(`${lang} documentation`, () => {
      ...
      beforeEach(() => {
        ...
        lang === 'EN' ? cy.visit(URL_EN) : cy.visit(URL_ES)
      })
      ...
      it('root redirects to first documentation page (checkout process)', () => {
        ...
        cy.get('h1').should('have.text', texts['1-checkout-process'])

        const childs = cy.get('.menu__link').contains(texts['1-checkout-process']).parent().siblings('ul').children('li')
        childs.should('have.length', 3)
      })

      it('check content 1 /checkout-process', () => {
        const link = cy.get('.menu__link').contains(texts['1-checkout-process'])
        link.click()
      ...
      it('check content 1-1 /checkout-process/installment-payment', () => {
        cy.get('.menu__link').contains(texts['1-1-installment-payment']).click()

        cy.get('h1').should('have.text', texts['1-1-installment-payment'])
        cy.get('h2').should('have.length', 1)
        cy.get('h3').should('have.length', 4)
      })

      it('check content 1-2 /checkout-process/pay-later-payment', () => {
        cy.get('.menu__link').contains(texts['1-2-pay-later-payment']).click()

        cy.get('h1').should('have.text', texts['1-2-pay-later-payment'])
        cy.get('h2').should('have.length', 1)
        cy.get('h3').should('have.length', 5)
      })

      it('check content 1-3 /checkout-process/pay-in-4-payment', () => {
        cy.get('.menu__link').contains(texts['1-3-pay-in-4-payment']).click()

        cy.get('h1').should('have.text', texts['1-3-pay-in-4-payment'])
        cy.get('h2').should('have.length', 1)
        cy.get('h3').should('have.length', 4)
      })

      it('check content 2 /category/entorno-de-pruebas', () => {
        cy.get('.menu__link').contains(texts['2-entorno-de-pruebas']).click()

        cy.get('h1').should('have.text', texts['2-entorno-de-pruebas'])
      ...
      it('check content 2-1 /test-environment/test-mode', () => {
        cy.get('.menu__link').contains(texts['2-entorno-de-pruebas']).siblings('button').click()
        cy.get('.menu__link').contains(texts['2-1-test-mode']).click()

        cy.get('h1').should('have.text', texts['2-1-test-mode'])
      })

      it('check content 2-2 /test-environment/test-data', () => {
        cy.get('.menu__link').contains(texts['2-entorno-de-pruebas']).siblings('button').click()
        cy.get('.menu__link').contains(texts['2-2-test-data']).click()

        cy.get('h1').should('have.text', texts['2-2-test-data'])
      })

      it('check content 3 /api-reference/', () => {
        cy.get('.menu__link').contains(texts['3-api-reference']).click()

        cy.get('h1').should('have.text', texts['3-api-reference'])
        cy.get('h2').should('have.length', 7)
        cy.get('h3').should('have.length', 8)
      })

      it('check content 4 /checkout-creation/', () => {
        cy.get('.menu__link').contains(texts['4-checkout-creation']).click()

        cy.get('h1').should('have.text', texts['4-checkout-creation'])
      ...
      it('check content 5 /sdk-javascript/', () => {
        cy.get('.menu__link').contains(texts['5-sdk-javascript']).click()

        cy.get('h1').should('have.text', texts['5-sdk-javascript'])
        cy.get('h2').should('have.length', 7)
        cy.get('h3').should('have.length', 0)
      ...
      it('check content 5-1 /sdk-javascript/checkout-postmessage/', () => {
        cy.get('.menu__link').contains(texts['5-sdk-javascript']).siblings('button').click()
        cy.get('.menu__link').contains(texts['5-1-checkout-postmessage']).click()

        cy.get('h1').should('have.text', texts['5-1-checkout-postmessage'])
        cy.get('h2').should('have.length', 2)
      ...
      it('check content 6 /sdk-ios/', () => {
        cy.get('.menu__link').contains(texts['6-sdk-ios']).click()

        cy.get('h1').should('have.text', texts['6-sdk-ios'])
      ...
      it('check content 7 /sdk-android/', () => {
        cy.get('.menu__link').contains(texts['7-sdk-android']).click()

        cy.get('h1').should('have.text', texts['7-sdk-android'])
        cy.get('h2').should('have.length', 4)
        cy.get('h3').should('have.length', 0)
        cy.get('table').should('have.length', 1)
      })
      ...
      it('check content 8 /checkout-confirmation/', () => {
        cy.get('.menu__link').contains(texts['8-checkout-confirmation']).click()

        cy.get('h1').should('have.text', texts['8-checkout-confirmation'])
        cy.get('h2').should('have.length', 4)
      ...
      it('check content 9 /checkout-capture/', () => {
        cy.get('.menu__link').contains(texts['9-checkout-capture']).click()

        cy.get('h1').should('have.text', texts['9-checkout-capture'])
        cy.get('h2').should('have.length', 2)
      ...
      it('check content 10 /widget/', () => {
        const link = cy.get('.menu__link').contains(texts['10-widget'])
        link.click()

        cy.get('h1').should('have.text', texts['10-widget'])
        cy.get('h2').should('have.length', 4)
        cy.get('h3').should('have.length', 0)
        cy.get('table').should('have.length', 3)
      ...
      it('check content 10-1 /widget/installment-payment', () => {
        cy.get('.menu__link').contains(texts['1-checkout-process']).siblings('button').click() // Close first dropdown
        const link = cy.get('.menu__link').contains(texts['10-widget'])
        ...
        cy.get('h1').should('have.text', texts['10-1-installment-payment'])
        cy.get('h2').should('have.length', 2)
        cy.get('h3').should('have.length', 2)
        cy.get('table').should('have.length', 2)
      ...
      it('check content 10-2 /widget/pay-later', () => {
        ...
        cy.get('h1').should('have.text', texts['10-2-pay-later'])
        cy.get('h2').should('have.length', 1)
        cy.get('h3').should('have.length', 1)
        cy.get('table').should('have.length', 1)
        cy.get('.form-configurator').should('have.length', 1)
      ...
      it('check content 10-3 /widget/pay-in-4', () => {
        ...
        cy.get('h1').should('have.text', texts['10-3-pay-in-4'])
        cy.get('h2').should('have.length', 1)
        cy.get('h3').should('have.length', 1)
        cy.get('table').should('have.length', 1)
      ...
      it('check content 10-4 /widget/custom-styles', () => {
        cy.get('.menu__link').contains(texts['10-widget']).siblings('button').click() // Open widget dropdown
        cy.get('.menu__link').contains(texts['10-4-custom-styles']).click()

        cy.get('h1').should('have.text', texts['10-4-custom-styles'])
        cy.get('h2').should('have.length', 1)
        cy.get('h3').should('have.length', 1)
        cy.get('table').should('have.length', 0)
        cy.get('.form-configurator').should('have.length', 1)
      ...
      it('check content 10-5 /widget/widget-v4', () => {
        cy.get('.menu__link').contains(texts['10-widget']).siblings('button').click()
        cy.get('.theme-doc-sidebar-item-link-level-2 .menu__link').contains(texts['10-5-widget-v4']).click()

        cy.get('h1').should('have.text', texts['10-5-widget-v4'])
        cy.get('h2').should('have.length', 1)
        cy.get('h3').should('have.length', 1)
        cy.get('table').should('have.length', 1)
        cy.get('.form-configurator').should('have.length', 1)
      ...
      it('check content 11 /api-orders/', () => {
        const link = cy.get('.menu__link').contains(texts['11-api-orders'])
        link.click() // go to the page

        cy.get('h1').should('have.text', texts['11-api-orders'])
      ...
      it('check content 12 /api-campaigns/', () => {
        const link = cy.get('.menu__link').contains(texts['12-api-campaigns'])
        link.click() // go to the page

        cy.get('h1').should('have.text', texts['12-api-campaigns'])
      ...
      it('check content 13 /checkout-offline/', () => {
        cy.get('.menu__link').contains(texts['13-checkout-offline']).click()

        cy.get('h1').should('have.text', texts['13-checkout-offline'])
        cy.get('h2').should('have.length', 3)
        cy.get('h3').should('have.length', 4)
